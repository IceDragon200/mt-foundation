/**
 * Below are some utilities for foundation written in C to speed up execution
 */
#include <stdint.h>
#include <assert.h>
...
static inline int write_to_buffer(struct foundation_encode_cursor* cursor, char* buffer, char value)
{
...
static inline void hold_byte(struct foundation_encode_cursor* cursor, char byte)
{
...
static inline int write_to_buffer_or_hold(struct foundation_encode_cursor* cursor, char* buffer, char byte)
{
...
static inline int resolve_held_bytes(struct foundation_encode_cursor* cursor, char* buffer)
{
