...
case:describe("format_le_binary/4", function (t2)
  t2:test("can format a ulid given its components", function (t3)
    t3:assert_eq("\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", mod.format_le_binary(0, 0, 0, 0))
  end)
end)

case:describe("format_be_binary/4", function (t2)
  t2:test("can format a ulid given its components", function (t3)
    t3:assert_eq("\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", mod.format_be_binary(0, 0, 0, 0))
  end)
end)
