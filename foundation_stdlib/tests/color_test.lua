...
case:describe("from_colorstring/1", function (t2)
  t2:test("can convert a ColorString (#RGB) to a ColorSpec", function (t3)
    t3:assert_table_eq(m.from_colorstring("#000"), m.new(0, 0, 0, 255))
    t3:assert_table_eq(m.from_colorstring("#128"), m.new(17, 34, 136, 255))
    t3:assert_table_eq(m.from_colorstring("#FFF"), m.new(255, 255, 255, 255))
  end)

  t2:test("can convert a ColorString (#RGBA) to a ColorSpec", function (t3)
    t3:assert_table_eq(m.from_colorstring("#000F"), m.new(0, 0, 0, 255))
    t3:assert_table_eq(m.from_colorstring("#128F"), m.new(17, 34, 136, 255))
    t3:assert_table_eq(m.from_colorstring("#FFFF"), m.new(255, 255, 255, 255))
  end)

  t2:test("can convert a ColorString (#RRGGBB) to a ColorSpec", function (t3)
    t3:assert_table_eq(m.from_colorstring("#000000"), m.new(0, 0, 0, 255))
    t3:assert_table_eq(m.from_colorstring("#0F1F7F"), m.new(15, 31, 127, 255))
    t3:assert_table_eq(m.from_colorstring("#FFFFFF"), m.new(255, 255, 255, 255))
  end)

  t2:test("can convert a ColorString (#RRGGBBAA) to a ColorSpec", function (t3)
    t3:assert_table_eq(m.from_colorstring("#000000FF"), m.new(0, 0, 0, 255))
    t3:assert_table_eq(m.from_colorstring("#0F1F7FFF"), m.new(15, 31, 127, 255))
    t3:assert_table_eq(m.from_colorstring("#FFFFFFFF"), m.new(255, 255, 255, 255))
  end)
end)
