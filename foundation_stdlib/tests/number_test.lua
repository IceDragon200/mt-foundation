...
case:describe("integer_crockford_base32_be_encode/2", function (t2)
  t2:test("can encode an integer as base32", function (t3)
    t3:assert_eq("00", m.integer_crockford_base32_be_encode(0, 1))
    t3:assert_eq("0F", m.integer_crockford_base32_be_encode(15, 1))
    t3:assert_eq("0000", m.integer_crockford_base32_be_encode(0, 2))
    t3:assert_eq("00000", m.integer_crockford_base32_be_encode(0, 3))
    t3:assert_eq("3FAVFQF", m.integer_crockford_base32_be_encode(0xDEADBEEF, 4))
    t3:assert_eq("0XSNJG0", m.integer_crockford_base32_be_encode(1000000000, 4))
  end)
end)

case:describe("integer_crockford_base32_le_encode/2", function (t2)
  t2:test("can encode an integer as base32", function (t3)
    t3:assert_eq("00", m.integer_crockford_base32_le_encode(0, 1))
    t3:assert_eq("F0", m.integer_crockford_base32_le_encode(15, 1))
    t3:assert_eq("0000", m.integer_crockford_base32_le_encode(0, 2))
    t3:assert_eq("00000", m.integer_crockford_base32_le_encode(0, 3))
    t3:assert_eq("FQFVAF3", m.integer_crockford_base32_le_encode(0xDEADBEEF, 4))
    t3:assert_eq("0GJNSX0", m.integer_crockford_base32_le_encode(1000000000, 4))
  end)
end)

case:describe("number_round/1", function (t2)
  t2:test("can round a floating point number", function (t3)
    t3:assert_eq(m.number_round(12.0), 12)
    t3:assert_eq(m.number_round(12.1), 12)
    t3:assert_eq(m.number_round(12.5), 13)
    t3:assert_eq(m.number_round(12.9), 13)
  end)
end)

case:describe("number_round/2", function (t2)
  t2:test("can round a floating point number to specified decimal places", function (t3)
    t3:assert_eq(m.number_round(12.7330, 1), 12.7)
    t3:assert_eq(m.number_round(12.123, 2), 12.12)
    t3:assert_eq(m.number_round(12.542, 2), 12.54)
    t3:assert_eq(m.number_round(12.9512, 3), 12.951)
  end)
end)
