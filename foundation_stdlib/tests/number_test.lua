...
case:describe("number_interpolate/3", function (t2)
  t2:test("will apply given amount to first value to eventually match second value", function (t3)
    t3:assert_eq(5, m.number_interpolate(0, 10, 5))
    t3:assert_eq(5, m.number_interpolate(10, 0, 5))
    t3:assert_eq(6, m.number_interpolate(2, 20, 4))
    t3:assert_eq(16, m.number_interpolate(20, 2, 4))
  end)
end)
